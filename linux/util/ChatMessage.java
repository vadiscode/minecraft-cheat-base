...
public class ChatMessage {
    ...
    ChatMessage(ChatComponentText chatComponentText, ChatMessage chatMessage) {
    ...
    public static class ChatMessageBuilder {
        ...
        public ChatMessageBuilder(boolean prependDefaultPrefix, boolean useDefaultMessageColor) {
            if (prependDefaultPrefix) {
                this.theMessage.appendSibling(new ChatMessageBuilder(false, false).appendText(String.valueOf(Client.clientName) + ": ").setColor(EnumChatFormatting.GREEN).build().getChatComponent());
            }
