...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public Location getLocation() {
        Location location = new Location(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch);
        return location;
    }
    
    public void onUpdateWalkingPlayer()
    {
        UpdateEvent pre = new UpdateEvent(this.posY, this.rotationYaw, this.rotationPitch, this.onGround);
        pre.call();
        if (new Aura().getInstance().isEnabled() && mc.gameSettings.thirdPersonView != 0) {
            this.lolPitch = pre.getPitch();
            this.rotationYawHead = pre.getYaw();
            this.renderYawOffset = pre.getYaw();
        }
        if (pre.isCancelled()) {
