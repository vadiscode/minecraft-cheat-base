...
import linux.module.modules.render.ESP;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            if (new ESP().getInstance().isEnabled() && ESP.outline == true && entitylivingbaseIn instanceof EntityPlayer && entitylivingbaseIn != Minecraft.getMinecraft().thePlayer) {
                ...
                } else if (entitylivingbaseIn instanceof EntityPlayer && FriendManager.isFriend(entitylivingbaseIn.getName())) {
                    GL11.glColor3f(0.25f, 0.65f, 1.0f);
                } else {
                ...
                GL11.glColor4d(0.175, 0.175, 0.175, 1.0);
                OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, 240.0f, 240.0f);
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                GL11.glDisable(2848);
                GL11.glEnable(2896);
    ...
    public void renderName(T entity, double x, double y, double z)
    {
        ...
        {
        	NormaltagsEvent tags = new NormaltagsEvent();
            tags.call();
            if (tags.isCancelled()) {
                return;
            }
