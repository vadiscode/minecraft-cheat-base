...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
    	if (msg.startsWith(".")) {
            String commandMsg = msg.replace(".", "");
            Command commandFromMessage = CommandManager.getCommandFromMessage(commandMsg);
    ...
    public void drawBackground(int tint)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("linux/background.jpg"));
